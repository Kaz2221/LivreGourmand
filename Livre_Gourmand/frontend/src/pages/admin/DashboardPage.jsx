...
import { FaMoneyBill, FaShoppingCart, FaChartLine, FaUsers, FaEllipsisV } from 'react-icons/fa';
...
// Composant pour afficher le graphique des revenus
const RevenueChart = () => {
  // Version simplifiée sans recharts pour corriger l'erreur
  return (
    <div className="h-64 w-full flex items-center justify-center text-white/70">
      <div>
        <p className="text-center mb-2">Graphique des revenus mensuels</p>
        <p className="text-xs text-center">(Version simplifiée - Recharts sera implémenté ultérieurement)</p>
      </div>
    </div>
  );
};
